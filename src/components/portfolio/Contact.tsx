      ...
      <div className="container relative">
        ...
        >
          <h2 className="font-display text-5xl md:text-7xl font-bold leading-[0.95] text-balance">
            Have data that needs <span className="text-gradient-primary">a story?</span>
          </h2>
          <p className="mt-6 text-lg text-muted-foreground max-w-2xl">
            {hero.availability}. Drop a line — happy to chat about dashboards, SQL, or your next BI build.
          </p>
        </motion.div>
